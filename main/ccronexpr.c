...
time_t mktime(struct tm* __tp);//timegm(struct tm* __tp);
#endif /* ANDROID */
time_t cron_mktime(struct tm* tm) { 
#ifndef ANDROID 

    return timegm_1(tm);//mktime(tm);//timegm_1(tm);//timegm(tm);//;
    //timegm(tm);
#else /* ANDROID */
...
#else /* !_WIN32 */
    return gmtime_r(date, out); //localtime_r(date, out);timegm_1
#endif /* _WIN32 */
#endif /* __MINGW32__ */
}
